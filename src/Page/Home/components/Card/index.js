        ...
        <div className="change_title">
          ...
          <div className="colorBase">
            <button
              ...
              onClick={() => handleColor("blue")}></button>
            <button
              className={color === "dGreen" ? "dGreen" : "dGreen"}
              onClick={() => handleColor("dGreen")}></button>
            <button
              className={color === "lBrown" ? "lBrown" : "lBrown"}
              onClick={() => handleColor("lBrown")}></button>
            <button
              className={color === "green" ? "green" : "green"}
              onClick={() => handleColor("green")}></button>
            <button
              className={color === "purple" ? "purple" : "purple"}
              onClick={() => handleColor("purple")}></button>
            <button
              className={color === "brown" ? "brown" : "brown"}
              onClick={() => handleColor("brown")}></button>
            <button
              className={color === "red" ? "red" : "red"}
              onClick={() => handleColor("red")}></button>
            <button
              className={color === "pink" ? "pink" : "pink"}
              onClick={() => handleColor("pink")}></button>
          </div>
        </div>
        <div className="change_title">
          <p>Blend & Dark</p>
          <div className="colorBase_blend">
            ...
            <button
              ...
              onClick={() => handleColor("white")}></button>
          </div>
        </div>
      </div>
    </>
